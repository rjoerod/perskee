...
const EpicBadge = ({ modalItem, boardId }: EpicBadgeProps) => {
	...
	const onEpicConfirm = async (epic: Task | string) => {
		...
		try {
			...
			// TODO: request new indexed data
			// mutate(`/api/board/${boardId}`);
			// mutate(`/api/task/get/epics?filtered=true`);

			// TODO: replace next routing
			// const params = new URLSearchParams(searchParams ?? undefined);
			// if (params.get("epic_id")) {
			// 	route(router, searchParams, pathname ?? "", "epic_id", newEpic);
			// }
		} catch (e) {
